...
#define LINE_BASE_PWM      2200
#define LINE_LOAD_PWM_BOOST 2400
#define LINE_KP            52
#define LINE_KD            5
#define LINE_PWM_LIMIT     5000
#define LINE_CROSS_COUNT   5
#define TURN_BASE_SPEED    22
#define LINE_TURN_SLOW_ERROR   8
#define LINE_TURN_BASE_PWM     1200
#define LINE_TURN_INNER_PERCENT 55
#define LINE_SHARP_ERROR       30
#define LINE_SHARP_PWM         5000
#define LINE_SHARP_LOST_PWM    5500
#define LINE_SHARP_BRAKE_TICKS 1
#define LINE_SHARP_EXIT_TICKS  3
#define LINE_CROSS_CONFIRM_TICKS 3
#define LINE_CROSS_RELEASE_TICKS 3
#define LINE_SEARCH_OUTER_PWM  4500
#define LINE_SEARCH_INNER_PWM  1800
#define LINE_ACCEL_RAMP_STEP 180
#define LINE_BRAKE_RAMP_STEP 220
#define LINE_DIFF_LIMIT     4
#define LINE_ERROR_FILTER_NUM  5
